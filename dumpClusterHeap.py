...
def dumpClusterHeap(clusterName):
   try:
      ...
      if (clusterState == "websphere.cluster.stopped"):
         print "Exception: All JVMs in cluster "  + clusterName + " are currently stopped, unable to generate heap dump!"
         status = _FAILURE_
         print "Status: ", status
      else:
         print ""
         print "INFO: Heap dump for " + clusterName + " in progress..."
         print ""
         ...
         for member in clusterMembers.split(lineSep):
            ...
            if (serverMBean != ''):
               ...
               print "INFO: Generating heap dump for " +serverName
               status = _SUCCESS_
               print "Status: ", status
               print ""
            else:
               print "INFO: Server " +serverName+ " is currently stopped, unable to generate heap dump!"
