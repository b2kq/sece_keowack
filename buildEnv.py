...
def configJVM(nodeNode, appSvrNode, CLUSTERED):
    ...
    for i in range(nodeList.getLength()):
	    ...
	    if(((env == 'UATWAS') | (env == 'UATWAS7') | (env == 'UATWAS8') | (env == 'PRODWAS') | (env == 'PRODWAS7') | (env == 'PRODWAS8')) & ((jvmName != 'nodeagent') & (jvmName != 'dmgr'))):
    ...
    if(nodeName.find("imwas") >= 0):
        print "INFO: configJVM: Will not change core group setting for IDM"
        return
